...
app.innerHTML = `
  <header class="hero">
    <div class="wrap">
      ...
      <p class="hero-link"><a href="./manifesto.html">See also: <b>Manifesto tracker</b> — every pledge Hannah Mary made, and where it stands <span aria-hidden="true">→</span></a></p>
      <p class="hero-link" style="margin-top:.5rem"><a href="./visits.html">And: <b>Around Shetland</b> — where Hannah Mary's been across the islands <span aria-hidden="true">→</span></a></p>
    </div>
  </header>
